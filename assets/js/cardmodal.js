  ...
  function render(card) {
    ...
    content.innerHTML = `
      ...
      <div class="modal-section" data-o-section="upright">
        ...
        <div class="modal-text">${TarotUI.paragraphs(card.meaning)}</div>
      </div>
      ...
      <div class="modal-section reversed" data-o-section="reversed" style="display:none;">
        ...
        <div class="modal-text">${TarotUI.paragraphs(card.reMeaning)}</div>
      </div>

      <div class="modal-section">
        <h4>${TarotIcons.svg("book")}<span>${TarotUI.t("studyDescription")}</span></h4>
        <div class="modal-text">${TarotUI.paragraphs(card.description)}</div>
      </div>
    `;
